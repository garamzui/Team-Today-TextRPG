    ...
    */
    ...
    class CharacterDatabase : Database<string[]>
    {
        ...
        public string Data { get; private set; } =
            "0/전사/10/5/100/40/1/겁나쎄게 올려치기/강철피부/높은 방어력, 기본 공격력, 체력#" +
    ...
    class MonsterDatabase : Database<string[]>
    {
        ...
        public string Data { get; private set; } =
            ...
            "3/보어/5/8/3/20/300/40/3/합니다 입니다#" +
            "4/오크/7/10/5/40/600/60/4/지능은 매우 떨어지지만 무시무시한 힘을 가지고 있습니다 취이익 취익#" +
            "5/자쿰/10/12/10/100/1000/80/5/전설 속 지옥의 나무 알려진 정보가 극히 드물다 왠지 팔을 떨어뜨릴 수 있을 것 같다";
