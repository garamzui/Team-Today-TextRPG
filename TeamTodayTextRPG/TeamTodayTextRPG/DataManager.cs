    ...
    */
    ...
    class CharacterDatabase : Database<string[]>
    {
        ...
        public string Data { get; private set; } =
            "0/전사/12/5/100/40/1/겁나쎄게 올려치기/강철피부.#" +
            "1/마법사/3/3/50/100/3/썬더봁/마력증강.#" +
            "2/도적/7/1/75/75/10/연격/날쌘 움직임."; 
    ...
    class MonsterDatabase : Database<string[]>
    {
        ...
        public string Data { get; private set; } =
            ...
            "1/고블린/2/5/1/15/100/25/1/힘은 약하지만 약간의 지능을 가지고 있습니다. 어떤 모험가가 꾸준히 개체수를 줄이고 있습니다.#" +
            "2/울프/3/8/3/20/300/40/2/빠른 움직임으로 먹잇감을 사냥합니다. 무리 단위 생활을 하는 것이 일반적입니다.#" +
            "3/오크/4/10/5/40/600/60/3/지능은 매우 떨어지지만 무시무시한 힘을 가지고 있습니다. 취이익 취익.#" +
            "4/자쿰/5/12/10/100/1000/80/4/전설 속 지옥의 나무. 알려진 정보가 극히 드물다. 왠지 팔을 떨어뜨릴 수 있을 것 같다.";
    ...
    class ItemDatabase : Database<string[]>
    {
        ...
        public string Data { get; private set; } =
            //기본 지급
            "0/천 옷/0/3/0/0/매우 저렴한 방어구 입니다./500/1#" +
            "1/목검/2/0/0/0/초보자용 검입니다./700/0#" +

            //방어구
            "1/가죽 로브/0/5/0/0/ 입니다./3000/1#" +
            "2/체인 메일/0/18/0/0/전사 전용 갑옷입니다./3000/1#" +
            "3/흑월/0/13/0/0/도적 전용 갑옷입니다./3000/1#" +
            "4/흑월/0/13/0/0/도적 전용 갑옷입니다./3000/1#" +
            "5/흑월/0/13/0/0/도적 전용 갑옷입니다./3000/1#" +

            //무기

            "7/글라디우스/5/0/0/0/전사 전용 무기입니다./4000/0#" +
            "8/위저드 완드/3/0/0/5/마법사 전용 무기입니다./4000/0#" +
            "9/위저드 완드/3/0/0/5/마법사 전용 무기입니다./4000/0#" +
            "10/위저드 완드/3/0/0/5/마법사 전용 무기입니다./4000/0#" +
            "11/그레이트 소드/20/0/0/0/입니다./4000/0";
        /*
